...
export default function DescobertoPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-8">
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-8 shadow-xl">
        <h2 className="text-xl font-semibold text-white mb-4">Todos os Leads</h2>

        {leads.length === 0 ? (
          <p className="text-slate-500 text-center py-8">Nenhum lead encontrado.</p>
        ) : (
